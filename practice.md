	...
	<li id="francis_terry">
		<div class="profile-text">
			<div class="inset-image">
				<img src="/images/practice/francis-terry-6.jpg" alt="Francis Terry" class="tall" />
				<img src="/images/practice/francis-terry-6c.jpg" alt="Francis Terry" class="wide" />
			</div>
			<h2>Francis Terry</h2>
			...
			<p class="quote"><em>'A master draughtsman with tremendous experience and empathy for the neo-Classical tradition'</em>
				...
				In 2016, Francis left his father’s practice to form his own office. He continues to work on major country house projects, securing a series of significant ‘Gummer Law’ permissions (<a href="/thoughts/nppf-paragraph-84e-explained/" alt="NPPF Paragraph 84e Explained">see link for details</a>).
			</p><p>
