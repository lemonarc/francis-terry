...
<ul class="list">
	<li class="third">
		<a onclick="">
		<img src="/images/practice/francis-terry-5-b.jpg">
		<h3>Francis Terry</h3>
		<h5>MA (Cantab), Dip Arch, RIBA <br />Director</h5>
		</a>
	...
	<li class="third">
		<img src="/images/practice/miranda-terry-b.jpg">
		<h3>Miranda Terry</h3>
		<h5>MA (Cantab), Dip Arch, MSc (Lon), RIBA <br />Director</h5>
	</li>
	
	<li class="third">
		<img src="/images/practice/jo-knights-b.jpg">
		<h3>Jo Knights</h3>
		<h5>Finance Manager</h5>
	</li>	
	
	<li class="third">
		<img src="/images/practice/les-canham-b.jpg">
		<h3>Les Canham</h3>
		<h5>Senior Associate</h5>
	</li>	
	
	<li class="third">
		<img src="/images/practice/martyn-winney-b.jpg">
		<h3>Martyn Winney</h3>
		<h5>Senior Associate</h5>
	</li>	
	
	<li class="third">
		<img src="/images/practice/colin-day-b.jpg">
		<h3>Colin Day</h3>
		<h5>Associate</h5>
	</li>	
	
	<li class="third">
		<img src="/images/practice/aaron-eagle-b.jpg">
		<h3>Aaron Eagle</h3>
		<h5>Associate</h5>
	</li>	
	
	<li class="third">
		<img src="/images/practice/bethany-cheffins-b.jpg">
		<h3>Bethany Cheffins</h3>
		<h5>Architectural Technician</h5>
	</li>	
	
	<li class="third">
		<img src="/images/practice/lois-rutter-b.jpg">
		<h3>Lois Rutter</h3>
		<h5>Architectural Technician</h5>
	</li>
